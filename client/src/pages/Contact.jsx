        ...
        <div name='contact' className='w-full mt-16'>
            <div className='max-w-[1240px] mx-auto'>
                <div className='text-center'>
                    <h2 className='text-4xl font-bold mb-3 uppercase'>Trusted by shoppers across the globe!</h2>
                </div>
                ...
                <div className='grid md:grid-cols-2 gap-2 px-2 text-center'>
                    ...
                    <div className='border py-5 rounded-xl shadow-xl'>
                        ...
                        <p className='text-gray-400 mt-2'>Fulfillment</p>
                    </div>
                </div>
            </div>
            {/* Contact form */}
            <div className='my-8 py-8 bg-[#0a192f] flex justify-center items-center px-3 '>
                <form method='POST' action="" onSubmit={handleSubmit} className='flex flex-col max-w-[600px] w-full'>
                    <div className='pb-3 text-center'>
                        ...
                        <p className='text-gray-300'>Send us an email - support@thestore.com</p>
                    ...
                    <button className='text-white border-2 px-6 py-3 my-3 mx-auto hover:bg-red-800 hover:border-red-900 flex items-center' disabled={loading}>Lets Talk</button>
                </form>
            </div>
        </div>
    )
